...
const ModalPhoneLogin = ({ isOpen, onClose }) => {
    ...
    const signin = async () => {
        ...
        try {
            const response = await axios.post(`https://localhost:7282/api/Auth/CheckPhoneNumber`, {
    ...
    const verifyOtp = async () => {
        if (otp === "") {
            Swal.fire("Error", "OTP cannot be empty. Please enter your OTP.", "error");
            return;
        }
        ...
        try {
            ...
            try {
                const response = await axios.post(`https://localhost:7282/api/Auth/LoginWithPhoneNumber`, {
                    PhoneNumber: convertPhoneNumber(phoneNumber)
                });
    ...
    return (
        <Modal show={isOpen} onHide={onClose} centered>
            ...
            <Modal.Body>
                <Form>
                    <Form.Group controlId="formPhone">
                        ...
                        <Form.Control type="tel" placeholder="Enter phone number" defaultValue="+84" onChange={handlePhoneNumberChange} />
                    ...
                    {confirmationResult && (
                        <Form.Group controlId="formOTP">
                            ...
                            <Form.Control type="text" placeholder="Enter OTP" onChange={handleOTPChange} />
                        </Form.Group>
                    )}
                </Form>
            </Modal.Body>
            <Modal.Footer>
                ...
                <Button variant="primary" onClick={confirmationResult ? verifyOtp : signin}>
