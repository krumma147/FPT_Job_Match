                          ...
                          <div className="filter-panel">
                            <div className="panel-content">
                              <div className="filter-topic cotain-common-filter">
                                <a href="#" className="filter-action">
                                  Tất cả ngành nghề
                                </a>
                            ...
                            <div className="panel-content">
                              <div className="filter-topic filter-input-price">
                                <form className="al-price-filter">
                                  ...
                                  <span className="_fpblock">
                                    <button type="submit" className="sb-fprice">
                                      <i
                          ...
                          <div className="job-inf">
                            ...
                            <div className="job-salary">
                              ...
                              <span className="salary-max">
                                35 <em className="salary-unit">triệu</em>
                              </span> */}
                            </div>
                            <div className="job-deadline">
                              <span>
                                <i
                                  ...
                                  aria-hidden="true"
                                />
                                Deadline: {j.application_deadline.split("T")[0]}
                              </span>
                            </div>
                          </div>
                        </div>
                      ...
                      <div className="job-inf">
                        ...
                        <div className="job-deadline">
                          <span>
                            ...
                            Hạn nộp: <strong>31/12/2019</strong>
                          </span>
                        </div>
                      </div>
                    </div>
                ...
                <div className="job pagi">
                  <div className="job-content">
                    <div className="job-logo">
                      <a href="#">
                        <img
                          src="assets/home/img/alipay-logo.png"
                          className="job-logo-ima"
                          alt="job-logo"
                        />
                      </a>
                    ...
                    <div className="job-desc">
                      ...
                      <div className="job-inf">
                        ...
                        <div className="job-deadline">
                          <span>
                            <i className="fa fa-clock-o" aria-hidden="true" />{" "}
                            Hạn nộp: <strong>31/02/2020</strong>
                          </span>
                        </div>
                      </div>
                    </div>
                ...
                <div className="job pagi">
                  <div className="job-content">
                    <div className="job-logo">
                      <a href="#">
                        <img
                          src="assets/home/img/nvg-logo.png"
                          className="job-logo-ima"
                          alt="job-logo"
                        />
                      </a>
                ...
                <div className="job pagi">
                  <div className="job-content">
                    <div className="job-logo">
                      <a href="#">
                        <img
                          src="assets/home/img/luxoft-vietnam-logo.png"
                          className="job-logo-ima"
                          alt="job-logo"
                        />
                      </a>
